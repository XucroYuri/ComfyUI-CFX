...
| ComfyUI-Vision | 7 | ✅ | Florence-2 ✅ / WD14 ✅ / BLIP ✅ | 1（VLM） |
...
| `comfyui_vision_vlm_caption` | `Qwen/Qwen2.5-VL-3B-Instruct` | ~7 GB | 非空描述 | ⏳ 待做（相对导入已修复） |
...
**已下载 ~2.1 GB**（WD14 + GDINO + u2net + BLIP；超分模型本机已有）；**剩余预算约 7 GB**（仅 VLM）。
